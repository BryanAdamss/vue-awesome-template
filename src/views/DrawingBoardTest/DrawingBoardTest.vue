<template>
  <div class="c-DrawingBoardTest">
    ...
    <button @click="handleGetDataUrl">
      getDataUrl
    </button>
    <button @click="handleGetBlob">
      getBlob
    </button>
    <button @click="handleGetFile">
      getFile
    </button>
    ...
    <button @click="handleBigBtnClick">
      放大
    </button>
    <button @click="handleSmallBtnClick">
      缩小
    </button>
    <button @click="handleOriginBtnClick">
      重置比例
    </button>

    <button @click="handlePaintBtnClick">
      画笔模式
    </button>
    <button @click="handleHandBtnClick">
      移动(抓手模式)
    </button>
    <button @click="handleEmptyBtnClick">
      重置画笔模式
    </button>

    <button @click="handleResetBtnClick">
      重置
    </button>
